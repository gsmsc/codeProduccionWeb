                        ...
                        <table class="table table-striped table-hover table-bordered mt-2 text-center" id="tblProduccion" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ strtoupper($items->descripcionEstilo) }}</td>
                                    <td class="text-center">
                                        <form action="" method="POST" class="formEliminarRegistro">
                                            @method('DELETE')
                                            @csrf
                                            @can('Produccion.Editar')
                                            <a href="#" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="Editar">
