...
<body>
    <div class="container-fluid">
        ...
        <div class="col-sm-12">
            <div>
                <form method="POST" action="{{ route('usuarios.update', $usuariosId->id) }}" id="formUpdateUsuario">
                    @method('PUT')
                    @csrf
                    <div class="col-sm-12">
                        @if ($errors->any())
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4 mt-2">
                                        ...
                                        <input type="text" value="{{ $usuariosId->name }}" name="name" id="name" class="form-control @error('name') is-invalid @enderror" maxlength="255" placeholder="..." required>
                                    </div>
                                    <div class="col-sm-5 mt-2">
                                        <label class="form-label" for="email">Correo electrónico</label>
                                        <div class="input-group">
                                            <input type="email" value="{{ $usuariosId->email }}" id="email" name="email" class="form-control @error('email') is-invalid @enderror" maxlength="255" placeholder="..." required>
                                    ...
                                    <div class="col-sm-3 mt-2">
                                        ...
                                        <div class="input-group">
                                            <input id="pass" class="form-control @error('password') is-invalid @enderror" value="{{ old('password') }}" type="pass" name="password" maxlength="255" />
                                            <span class="input-group-text">
                                    ...
                                    <div class="col-sm-3 mt-2">
                                        ...
                                        <div class="input-group">
                                            <select class="custom-select @error('idTipoUsuario') is-invalid @enderror" name="idTipoUsuario" id="idTipoUsuario" required>
                                                ...
                                                <option value="{{ $role->id }}" {{ $usuariosId->idRol == $role->id ? 'selected' : ''}}>
                                                    {{ $role->name }}
                                                </option>
                                                @endforeach
                                            </select>
...
<script>
    ...
    (function() {
        'use strict';
        var form = document.querySelectorAll('#formUpdateUsuario');
