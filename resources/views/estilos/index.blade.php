        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="container-title">
                    <h3>Listado de estilos</h3>
                </div>
            </div>
            <div class="col-sm-6">
                @can('Estilos.Crear')
                <a href="" class="btn btn-dark" style="float: right; margin-left:10px;" data-toggle="modal" data-target="#modalCreateEstilos">Registrar
...
<script>
    ...
    (function() {
        'use strict';
        var form = document.querySelectorAll('#formEstilos');
        form[0].addEventListener('submit', function(event) {
            ...
            if (true) {
                function validate() {
                    Swal.fire({
                        title: '¿Está seguro de registrar el estilo?',
                        icon: 'question',
    ...
    (function() {
        'use strict';
        var forms = document.querySelectorAll('.formEliminarEstilo');
        Array.prototype.slice.call(forms)
            .forEach(function(form) {
                form.addEventListener('submit', function(event) {
                    ...
                    event.stopPropagation();
                    Swal.fire({
                        title: '¿Está seguro de eliminar el estilo?',
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#00887A',
                        cancelButtonColor: '#6c757d',
