...
<body>
    <div class="container-fluid">
        ...
        <div class="col-sm-12">
            <div>
                <form method="POST" action="{{ route('roles.store') }}" id="formGrabarRoles">
                    @csrf
                    <div class="col-sm-12">
                        @if ($errors->any())
                                ...
                                <div class="row PRORI">
                                    <div class="col-sm-12 mt-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('name') }}" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="..." maxlength="255" required>
                                        </div>
                                    </div>
                                </div>
                                <label class="form-label navbar-example2 mt-3">Permisos</label>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input type="checkbox" value="{{ $p->nombrePermiso}}" name="nombrePermiso[]" id="checkPermisos{{ $p->idPermiso}}" @if(is_array(old('nombrePermiso')) && in_array($p->nombrePermiso, old('nombrePermiso'))) checked @endif
                                                        >
                                                    </div>
                                                </div>
                    ...
                    <div class="col-sm-12 buttons">
                        <a class="btn btn-dark mb-4" href="{{ route('roles.index') }}">Cancelar</a>
...
<script>
    ...
    (function() {
        'use strict';
        var form = document.querySelectorAll('#formGrabarRoles');
